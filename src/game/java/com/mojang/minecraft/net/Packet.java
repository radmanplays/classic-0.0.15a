...
public final class Packet {
	...
	public static final Packet LOGIN = new Packet(new Class[]{String.class});
	...
	static {
		...
		PLAYER_MOVE = new Packet(new Class[]{Byte.TYPE, Short.TYPE, Short.TYPE, Short.TYPE, Byte.TYPE, Byte.TYPE});
